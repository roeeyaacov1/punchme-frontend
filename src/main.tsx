...
import { watchForInstallPrompt } from "./pwa/installPrompt";
...
// Before render on purpose: `beforeinstallprompt` can fire while React is
// still mounting, it only fires once, and there is no way to ask for it back.
